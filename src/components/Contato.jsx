...
function Contato() {
  return (
    ...
    <section id="contato" className="py-16 pb-0">
      ...
      {/* ADICIONAMOS O PADDING HORIZONTAL AQUI E REFORÇAMOS O CONTAINER */}
      <div className="max-w-[1400px] mx-auto px-[5%]">
        <div className="flex flex-col-reverse lg:flex-row">
          
          {/* O CONTAINER DO FORMULÁRIO NÃO PRECISA MAIS DE PX AQUI */}
          <div className="flex-1 py-12 lg:py-12" data-aos="fade-right">
          ...
          {/* CORREÇÃO MAPA: O 'overflow-hidden' e 'w-full' são cruciais */}
          <div className="flex-1 min-h-[350px] lg:min-h-[500px] flex flex-col overflow-hidden w-full" data-aos="fade-left">
            <iframe 
